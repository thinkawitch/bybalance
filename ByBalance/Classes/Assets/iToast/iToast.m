...
- (void) show:(iToastType) type{
	...
	CGSize textSize = [text sizeWithFont:font constrainedToSize:CGSizeMake(280, 80)];
	...
	v.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.7f];
	...
	switch (orientation) {
		...
		{
			v.transform = CGAffineTransformMakeRotation((CGFloat)M_PI/2); //rotation in radians
