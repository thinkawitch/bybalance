...
// Creates and adds an activity view centered within the UIApplicatin root view, using the label "Loading...".  Returns the activity view, already added as a subview of the specified view:
